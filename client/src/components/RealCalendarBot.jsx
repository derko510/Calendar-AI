...
const RealCalendarBot = ({ userCredential, events }) => {
  ...
  const handleSync = async () => {
    ...
    setIsSyncing(true);
    try {
      const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://server-b3k7nkn9g-derricks-projects-0ffc821f.vercel.app';
      console.log('🔗 API_BASE_URL:', API_BASE_URL); // Debug - remove after testing
